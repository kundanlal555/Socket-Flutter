...
import 'package:test_socket/UserNameVC.dart';
...
initSocket(String identifier) async {
    ...
    socket.on("wheater", (data){   //sample event
		  print("news");
		  print(data);
		});
    socket.on("Data", (data){   //sample event
		  print("news");
		  print(data);
		});
          ...
          children: <Widget>[
           ...
           TextField(
             ...
             OutlineButton(
                child: Text('LOGIN'),
                onPressed: () {
             socket.emit("setPseudo", [_usernameController.text]);
                }),
            Text(
             ...
             OutlineButton(
                child: Text('Send'),
                onPressed: () {
             socket.emit("message", [_msgTF.text]);
                }),
            Text(
              '$_counter',
